...
namespace Microsoft.Acoustics.Editor
{
    public class AcousticsProbesTab : ScriptableObject
    {
        ...
        public bool CalculateProbePoints(bool showDialog = true)
        {
            ...
            {
                MinCorner = AcousticsEditor.TritonVec3fFromVector3(AcousticsEditor.s_AcousticsParameters.PerProbeSimulationRegion_Lower),
                MaxCorner = AcousticsEditor.TritonVec3fFromVector3(AcousticsEditor.s_AcousticsParameters.PerProbeSimulationRegion_Upper)
            };
